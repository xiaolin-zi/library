    ...
    <script type="text/javascript">
        ...
        $(function () {
           ...
           $("button.addToCart").click(function () {
               ...
               //location.href="http://localhost:8080/book02/cartServlet?action=addItem&id="+bookId;
               $.getJSON("http://localhost:8080/book02/cartServlet","action=ajaxAddItem&id="+bookId,function (data){
          ...
          $("a.power").click(function () {
              if(${empty sessionScope.user}) {
                  if(confirm("您当前还未登录，是否前往登录？")){
                      ...
                      location.href="http://localhost:8080/book02/index.jsp";
                      return false;
                  }
              }
              if(${not empty sessionScope.user}&&${sessionScope.user.username!="admin"}){
                   if(confirm("您不是管理员，没有权限访问！")){
                       location.href="http://localhost:8080/book02/index.jsp";
                       return false;
                   }else {
                       location.href="http://localhost:8080/book02/index.jsp";
...
<div id="header">
    ...
    <div>
        ...
        <a class="power" href="pages/manager/manager.jsp">后台管理</a>
    </div>
</div>
<div id="main">
    <div id="book">
